...
from .routes import availability, calendars, chat, destinations, feedback, flights, health, meetup, profile, rooms
...
app.include_router(meetup.router, prefix="/api/rooms/{slug}/meetup", tags=["meetup"])
